...
Please follow the [installation steps from the README](https://github.com/uhs-robert/hyprvim/tree/main#-installation)

Then get started with [Configuration](./01_Configuration.md).

From there, work your way through [Basics](02_Basics.md), [Modes](03_Modes.md), [Advanced](04_Advanced.md), [Which Key](05_WhichKey.md), and [Tips and Tricks](06_Tips-and-Tricks.md).
